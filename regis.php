...
if (!$bookingdate) {
    ...
    $query = mysqli_query($con, "INSERT INTO tblbookings(bookingNo, fullName, emailId, phoneNumber, bookingDate, bookingTime, guest, boookingStatus)
        VALUES('$bno', '$fname', '$emailid', '$phonenumber', '$bookingdate', '$bookingtime', '$guest', '$boookingStatus')");
...
<div class="rcontainer">
	...
	<div><input type="hidden" name="boookingStatus" value="Pending"></div>
        ...
        <p>Reminder: Remember the Username you used.</p>
    </form>
</div>
